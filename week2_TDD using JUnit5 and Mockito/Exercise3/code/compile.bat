@echo off
echo ==============================================
echo   Compiling Exercise 3: Assertions in JUnit
echo ==============================================
echo.
...
echo 1. AssertionsTest - Basic assertions from the exercise
echo 2. ComprehensiveAssertionsTest - Extended assertion examples
echo 3. StudentTest - Practical assertion usage
echo.
echo To run individual tests:
echo java -cp "target\classes;target\test-classes;lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar" org.junit.runner.JUnitCore com.example.AssertionsTest
echo java -cp "target\classes;target\test-classes;lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar" org.junit.runner.JUnitCore com.example.ComprehensiveAssertionsTest
echo java -cp "target\classes;target\test-classes;lib\junit-4.13.2.jar;lib\hamcrest-core-1.3.jar" org.junit.runner.JUnitCore com.example.StudentTest
echo.
pause
