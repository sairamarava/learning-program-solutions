@echo off
echo ==============================================
echo   Exercise 3: Assertions in JUnit
echo ==============================================
echo.
...
echo.
echo Running Exercise 3: Basic Assertions Test...
java -cp "target\classes;target\test-classes;lib\*" org.junit.runner.JUnitCore com.example.AssertionsTest

echo.
echo Running Comprehensive Assertions Test...
java -cp "target\classes;target\test-classes;lib\*" org.junit.runner.JUnitCore com.example.ComprehensiveAssertionsTest

echo.
echo Running Student Test...
java -cp "target\classes;target\test-classes;lib\*" org.junit.runner.JUnitCore com.example.StudentTest
